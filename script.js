...
document.getElementById('siBtn').addEventListener('click', function () {
    ...
    message.innerHTML = '¡Oh Siii Honey! jajaja 💖';
...
document.getElementById('noBtn').addEventListener('click', function () {
    ...
    switch (noButtonState) {
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = '¿Seguro de verdad? 😢';
        ...
        case 10:
            document.getElementById('noBtn').innerHTML = 'Es broma… POR FAVOR DI SÍ 😭❤️';
